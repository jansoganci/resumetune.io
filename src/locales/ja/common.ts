const common = {
  appTitle: 'CareerBoost AI', appSubtitle: 'AIで求人マッチング、カバーレター、履歴書最適化', yourCV: '履歴書', addYourCV: '履歴書の内容を追加', checkJobMatch: '適合度を確認', analyzingMatch: '分析中...', aiAdvisor: 'AIキャリアアドバイザー', disclaimerTitle: '重要なお知らせ', howTo: '使い方：',
