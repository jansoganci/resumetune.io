const common = {
  appTitle: 'CareerBoost AI', appSubtitle: 'AI로 직무 매칭, 자기소개서, 이력서 최적화', yourCV: '이력서', addYourCV: '이력서 내용 추가', checkJobMatch: '매칭 확인', analyzingMatch: '분석 중...', aiAdvisor: 'AI 커리어 어드바이저', disclaimerTitle: '중요 안내', howTo: '사용 방법:',
